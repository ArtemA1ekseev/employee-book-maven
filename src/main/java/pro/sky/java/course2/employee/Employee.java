...
public class Employee {
    ...
    public Employee(String surname, String name, String middleName, int department, double salary) {
        ...
        //
        if ((surname != StringUtils.capitalize(surname) || name != StringUtils.capitalize(name) || middleName != StringUtils.capitalize(middleName))
                || (StringUtils.isBlank(surname) == true || StringUtils.isBlank(name) == true || StringUtils.isBlank(middleName) == true)
                || (StringUtils.isAlpha(surname) == false || StringUtils.isAlpha(name) == false || StringUtils.isAlpha(middleName) == false)) throw new IllegalArgumentException("400 Bad Request");
        //
        counter++;
        this.id = getCounter();
